    ...
    return (
      <div className="submit-form">
        {this.state.submitted ? (
          <div>
            <h4>Point added successfully!</h4>
            <Link
          ...
          >
            ...
            <button className="btn btn-primary" onClick={this.newPoint}>
              Add Another
            </button>
          </div>
        ) : (
          ...
          >
            ...
            <button onClick={this.savePoint} className="btn btn-primary">
              Add
            </button>
          </div>
        )}
